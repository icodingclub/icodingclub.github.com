...
var Keyboard = declare(null, {
    ...
    _focusOnNode: function(element, isHeader, event){
        ...
        // PATCH START: InputFocused This is required because the drop down loses focus once the cell is focused
        if (event && event.type === "mousedown" && event.target.type === "button" && !inputFocused) {
            inputFocused = true;
        }
        // if(event !== null){
        // PATCH END
        ...
        // PATCH START: InputFocused Indicate to the listener that we have already focused on a control.
        // }
        event.inputFocused = inputFocused || false;
        // PATCH END
