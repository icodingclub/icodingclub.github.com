 ...
 */
    ...
    return declare(null, {
        ...
        _updateColumnHiddenState: function(id, hidden){
            ...
            // If this grid is using ColumnResizer and a proportional resizeAlgorithm,
            // resize it in a way that maintains column width ratios
            if (this.resizeColumnWidth && this.resizeAlgorithm.indexOf("proportional") === 0) {
                this.proportionalResize(column.headerNode, column.width || this.minWidth);
            }
            // PATCH END
