define([
	...
	var PopupManager = declare(null, {
		...
		open: function(/*__OpenArgs*/ args){
			...
			//For smaller screens that helps every dropdown widget that doesn't fit except dijit/Menu
			if (node && ~node.className.indexOf("dijitMenu") && maxHeight !== 340) {
				maxHeight = 340; // also see Menu.scss, this needs to be 10 more than whats in the css to account for 5px top/bottom margin
			}
