define([
    ...
    var ComboBoxMenuMixin = declare("dijit.form._ComboBoxMenuMixin" + (has("dojo-bidi") ? "_NoBidi" : ""), null, {
        ...
        // START QBO-PATCH : QBO-32592 We should highlight the selected option in the dropdown
        //createOptions: function(results, options, labelFunc){
        createOptions: function(results, options, labelFunc, lastValueSelected){
        // END QBO-PATCH
            // summary:
            ...
            array.forEach(results, function(item, i){
                ...
                // START QBO-PATCH : QBO-32592 We should highlight the selected option in the dropdown
                if(lastValueSelected && lastValueSelected === item.id) {
