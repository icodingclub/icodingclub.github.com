define([
	...
	return declare("dijit.form._FormWidgetMixin", null, {
		...
		// START QBO-PATCH
		onTriggerBinding: function(/*===== newValue =====*/){
			// summary:
			//		Hack method to workaround onChange being called inside deferred
            // If you change this please update InlineEditBox, ComboBox, and Switch
		},
		// END QBO-PATCH
		...
		_handleOnChange: function(/*anything*/ newValue, /*Boolean?*/ priorityChange){
			...
			if((this.intermediateChanges || priorityChange || priorityChange === undefined) && this._pendingOnChange){
				...
				if(this._onChangeActive){
					...
					// START QBO-PATCH
					this.onTriggerBinding(newValue); // see onTriggerBinding def
					// END QBO-PATCH
